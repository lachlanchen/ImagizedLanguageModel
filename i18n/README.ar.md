...
ILM مشروع بحثي لتعلّم اللغة وتوليدها بوصفها **كتابة مرئية**. النموذج
الحالي يقرأ رقع الحبر المتتابعة، ويحافظ على حالة بصرية مستمرة، ويكتب الرقعة
التالية مباشرة بالبكسلات عبر التدفق المستقيم. تبقى تجارب دفاتر الأكواد
والانتشار السابقة خطوط أساس للمقارنة وليست مسار النموذج الحالي.

## النموذج الحالي: نموذج اللغة بالتدفق الشبكي

![مخطط نموذج اللغة بالتدفق الشبكي](../publication/ilm-image-native/figures/retinal_flow_paradigm.png)

حد الطالب صارم: `بكسلات كتابة -> حالة شبكية مستمرة -> بكسلات حبر`. لا يتلقى
الطالب رموز نصية أو معرفات Unicode أو OCR أو دفتر أكواد بصرياً أو نموذج لغة
خارجياً. حقق المشفر البصري دقة `97.65%` في اختبار الهوية البصرية، لكن دقة
التنبؤ بالسياق الكامل كانت `0.91%` فقط، وهي أقل من unigram (`1.86%`) وbigram
(`13.58%`). كما تنحرف الكتابة المستقلة إلى علامات غير مقروءة. لذلك **رُفض
النموذج الأولي الحالي كنموذج لغة**؛ والخطوة التالية هي التدريب على المسارات
البصرية التي يولدها النموذج نفسه، لا زيادة حجمه فوراً.
